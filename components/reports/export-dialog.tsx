    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>选择导出格式和内容选项，生成您需要的报表文件</DialogDescription>
        </DialogHeader>
                ...
                return (
                  <Card
                    ...
                    className={`cursor-pointer transition-colors ${
                      format === option.value ? 'ring-primary ring-2' : 'hover:bg-muted/50'
                    }`}
                    ...
                    <CardContent className="flex items-center space-x-3 p-4">
                      ...
                      <div
                        className={`h-4 w-4 rounded-full border-2 ${
                          format === option.value ? 'bg-primary border-primary' : 'border-muted-foreground'
                        }`}
                      />
                    </CardContent>
                  </Card>
