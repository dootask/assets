...
// 获取盘点任务列表
export const getInventoryTasks = async (params: InventoryTaskListQuery): Promise<APIResponse<PaginationResponse<InventoryTask[]>>> => {
...
// 更新盘点任务
export const updateInventoryTask = async (id: number, data: UpdateInventoryTaskRequest): Promise<APIResponse<InventoryTask>> => {
...
// 获取盘点记录列表
export const getInventoryRecords = async (params: InventoryRecordListQuery): Promise<APIResponse<PaginationResponse<InventoryRecord[]>>> => {
    const queryParams = new URLSearchParams();
...
// 创建盘点记录
export const createInventoryRecord = async (data: CreateInventoryRecordRequest): Promise<APIResponse<InventoryRecord>> => {
    const response = await apiClient.post('/inventory/records', data);
    return response.data;
};

// 批量创建盘点记录
export const batchCreateInventoryRecords = async (data: BatchCreateInventoryRecordsRequest): Promise<APIResponse<{ message: string; count: number; records: InventoryRecord[] }>> => {
