  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">借用统计报表</h1>
                  ...
                  <div key={index} className="flex items-center justify-between p-3 border rounded-lg">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                        总借用: {department.borrow_count} | 活跃: {department.active_count} | 超期: {department.overdue_count}
                      </p>
                    </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-2xl font-bold text-red-600">
                      {overdue_analysis.total_overdue}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium">超期率</span>
                    <span className="text-lg font-semibold">
                      {overdue_analysis.overdue_rate.toFixed(1)}%
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium">平均超期天数</span>
                    <span className="text-lg font-semibold">
                      {overdue_analysis.average_overdue_days.toFixed(1)} 天
                    </span>
                  </div>
                </div>
              </CardContent>
                    ...
                    <div className="text-right">
                      <div className="flex space-x-4">
                        <div className="text-center">
                          ...
                          <div className="text-xs text-muted-foreground">借用</div>
                        </div>
                        <div className="text-center">
                          <div className="text-sm font-medium text-green-600">
                            {month.return_count}
                          </div>
                          <div className="text-xs text-muted-foreground">归还</div>
                        </div>
                      </div>
                    </div>
                  </div>
