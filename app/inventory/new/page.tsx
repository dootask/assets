            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value: 'full' | 'category' | 'department') =>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
                  ...
                  <div className="mt-2 grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-4">
                    {departments.map(department => (
                      <div key={department.id} className="flex items-center space-x-2">
                        ...
                        />
                        <Label htmlFor={`department-${department.id}`} className="cursor-pointer text-sm font-normal">
                          {department.name}
                        </Label>
                      </div>
                    ))}
              ...
              <div className="space-y-2">
                ...
                />
                <p className="mt-1 text-sm text-gray-500">将筛选包含此关键词的资产位置</p>
              </div>
            </CardContent>
          </Card>
