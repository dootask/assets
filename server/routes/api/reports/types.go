...
type WarrantyStatus struct {
	...
	OutOfWarranty int64 `json:"out_of_warranty"` // 保修期外
	NoWarrantyInfo int64 `json:"no_warranty_info"` // 无保修信息
}
...
type DashboardReportData struct {
	...
	BorrowOverview   BorrowOverview   `json:"borrow_overview"`
	InventoryOverview InventoryOverview `json:"inventory_overview"`
...
type InventoryOverview struct {
	...
	InProgressTasks int64   `json:"in_progress_tasks"`
	CompletedTasks  int64   `json:"completed_tasks"`
	LastAccuracyRate float64 `json:"last_accuracy_rate"`
}
